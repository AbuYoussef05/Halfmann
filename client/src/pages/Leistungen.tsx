  ...
  const storageServices = [
    {
      ...
      description: 'Besonders schonende Lagerung für historische und wertvolle Fahrzeuge',
      features: ['Klimatisierte Lagerung', 'Winterlagerung', 'Besondere Sicherheitsmaßnahmen']
    },
    {
      icon: Warehouse,
